# Generated by Django 5.1 on 2025-01-14 23:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text="Author's name", max_length=100)),
                ('last_name', models.CharField(help_text="Author's surname", max_length=100)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Book genre', to='library.genre')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarks', models.ManyToManyField(blank=True, related_name='bookmarked_by', to='library.book')),
            ],
            options={
                'verbose_name': 'user',
